...
describe('Token', () => {
  ...
  test('shows the updated Buff tooltip in English and Japanese', () => {
    const { rerender } = render(
      <Token ariaLabel="Buff token" language="en" showName tokenType="purple" />
    );
    ...
    rerender(
      <Token ariaLabel="Buff token" language="jp" showName tokenType="purple" />
    );
